...
<div class="card">
    ...
    <input type="hidden" value="<?php echo $data_customer->customer_id; ?>" name="id" id="id">
    </form> 
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="crop">Crop</button>
         ...
         <div class="profile-image">
         <?php if ($data_customer->passport == TRUE) {
          ?>
           <img src="<?php echo base_url().$data_customer->passport; ?>" class="img-thumbnail" alt="customer image" style="width: 160px;height: 160px;">
          <?php }else{ ?> 
           ...
           <!--  <button type="submit" class="btn btn-primary"><i class="icon-pencil">Save</i></button> -->
            <a href="<?php echo base_url("admin/customer_profile/{$data_customer->customer_id}") ?>" class="btn btn-primary btn-elevate btn-pill">Finish</a>
            </div>
    ...
    bs_modal.on('shown.bs.modal',function(){
        ...
        reader.onload = function(){
            ...
            $.ajax({
                type:"POST",
                //dataType:"json",
                url:"<?php echo base_url(); ?>admin/update_customerID",
