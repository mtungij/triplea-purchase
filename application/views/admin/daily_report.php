            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                         <div class="header">
                            <?php $date = date("Y-m-d"); ?>
                            <h2>General Daily Report / <?php echo $date; ?></h2> 
                          ...
                          <div class="body">
                            <div class="table-responsive">
                                <table class="table table-hover j-basic-example dataTable table-custom">
                                    ...
                                    <?php endforeach; ?>
                                    <?php $income_today = $this->queries->get_today_income_data_comp($data_account_datas->comp_id,$data_account_datas->receive_trans_id) ?>
                                    ...
                                    <?php $non_deducted = $this->queries->get_nondeducted_income_account_company($data_account_datas->comp_id,$data_account_datas->receive_trans_id);
                                    // echo "<pre>"; 
                                    ...
                                    <tr>
                                     ...
                                     <?php endforeach; ?>
                                     <?php $prepaid = $this->queries->get_today_prepaid_comp($data_account_datas->comp_id,$data_account_datas->receive_trans_id);
                                       //    echo "<pre>";
                                       // print_r($prepaid);
                                      ?>
                                <?php foreach ($prepaid as $prepaids): ?>
                                     ...
                                     <?php endforeach ?>
                                     <?php $accrual_income = $this->queries->get_out_deposit_today_company($data_account_datas->comp_id,$data_account_datas->receive_trans_id);
                                    ...
                                    <?php endforeach; ?>
                                      <?php $daily_deposit = $this->queries->get_daily_deposit_company($data_account_datas->comp_id,$data_account_datas->receive_trans_id);
                                      // echo "<pre>";
                                    ...
                                    <?php $weekly_deposit = $this->queries->get_weekly_deposit_comp($data_account_datas->comp_id,$data_account_datas->receive_trans_id);
                                    ...
                                    <?php endforeach; ?>
                                <?php $monthly_deposit = $this->queries->get_monthly_deposit_company($data_account_datas->comp_id,$data_account_datas->receive_trans_id);
                                //print_r($monthly_deposit) ?>
                                 <?php foreach ($monthly_deposit as $monthly_deposits): ?>
                                    ...
                                    <?php endforeach; ?>
                                 <?php $loan_pending = $this->queries->get_system_loan_return_company($data_account_datas->comp_id,$data_account_datas->receive_trans_id);
                                  ...
                                  ?>
                                   <?php foreach ($loan_pending as $loan_pendings): ?>
                                    ...
                                    <?php endforeach; ?>
                                    <?php $double_loan = $this->queries->get_double_amount_company($data_account_datas->comp_id,$data_account_datas->receive_trans_id);?>
                                    ...
                                    <?php $from_main_account = $this->queries->get_transaction_from_mainAccount_company($data_account_datas->comp_id,$data_account_datas->receive_trans_id); ?>
                                    <?php 
                                    // echo "<pre>";
                                    // print_r($from_main_account); 
                                    ?>
                                    ...
                                    <tr>
                                     ...
                                     <?php endforeach; ?>
                                     <?php $from_blanch_blanch = $this->queries->get_transaction_from_company($data_account_datas->comp_id,$data_account_datas->receive_trans_id);
                                     // echo "<pre>";
                                    ...
                                    <?php endforeach; ?> 
                                     ...
                                     <?php $loan_with = $this->queries->get_loan_withdrawal_account_company($data_account_datas->comp_id,$data_account_datas->receive_trans_id);
                                     // echo "<pre>";
                                     // print_r($loan_with) ?>
                                     ...
                                     <?php endforeach; ?>
                                     <?php $renew_loan = $this->queries->get_loan_renew($data_account_datas->comp_id,$data_account_datas->receive_trans_id);
                                     // echo "<pre>";
                                     // print_r($renew_loan);
                                      ?>
                                      <?php foreach ($renew_loan as $renew_loans): ?>
                                     <tr>
                                         <td>RENEW LOAN</td>
                                         <td><?php echo number_format($renew_loans->total_renew); ?></td>
                                     </tr>
                                     <?php endforeach; ?>

                                     <?php $expenses = $this->queries->get_expenses_datas_company($data_account_datas->comp_id,$data_account_datas->receive_trans_id);
                                     // print_r($expenses) 
                                     ?>
                                     ...
                                     <?php endforeach; ?>
                                     <?php $transactions_float = $this->queries->get_transaction_day_company($data_account_datas->blanch_id,$data_account_datas->receive_trans_id);
                                     // echo "<pre>";
                                    ...
                                    <tr>
                                      ...
                                      <tr>
                                          ...
                                          <td><b><?php echo number_format(@$expenses_blanch->total_expenses_blanch + $withdrawal_today_expenses->total_loan_with + $transaction_float->total_transaction_float + $total_renew->total_renew); ?></b></td>
                                      </tr>
                                      <tr>
