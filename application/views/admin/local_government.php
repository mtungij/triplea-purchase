            ...
            ?>
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <?php echo form_open_multipart("admin/Update_local_govDetails/{$loan_attach->loan_id}/{$attach_id}") ?>
                            <div class="row">
                        ...
                        <input type="hidden" name="loan_id" value="<?php echo $loan_attach->loan_id; ?>">
                               ...
                               <?php if ($alert_loan->group_id == TRUE) {
                                ?>
                             <a href="<?php echo base_url("admin/loan_group_pending"); ?>" class="btn btn-primary">Finish</a>
                            <?php }else{ ?>
