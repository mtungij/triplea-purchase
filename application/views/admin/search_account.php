                                ...
                                <table class="table table-hover j-basic-example dataTable table-custom">
                                   ...
                                   <?php //print_r($out_stand); ?>
                                        <tr>
                                            ...
                                            <td><?php echo number_format($total_deposit->total_Deposit + $total_deposit->total_double) ?></td>
                                            <td><?php echo number_format(($customer_loan->loan_int) - ($total_deposit->total_Deposit + $total_deposit->total_double) ) ?></td>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover j-basic-example dataTable table-custom">
                                    ...
                                    <?php } ?><?php //echo $payisnulls->session; ?>  / AC/No. <?php echo @$payisnulls->loan_code; ?>
                                            ...
                                            <td> <?php if (@$payisnulls->rem_debt == TRUE || @$payisnulls->rem_debt == '0') {
                             ?>
