                         ...
                         <div class="header">
                            ...
                            <div class="pull-right">
                                ...
                                <?php if (count($data_expected) > 0) {
                                 ?>
                                 <a href="<?php echo base_url("admin/print_expected_receivable/{$from}/{$to}/{$blanch_id}"); ?>" class="btn btn-primary" target="_blank">
                       ...
                       <?php endforeach; ?>
                                <tr>
                                   ...
                                   <!--  <td></td> -->
                                    <td></td>
                                    <td></td>
                                    <td><b><?php //echo number_format($sum_expectation->total_expectation); ?></b></td>
                                    <td><b><?php echo number_format($sum_expectation->total_expectation); ?></b></td>
