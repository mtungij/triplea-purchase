        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Loan Withdrawal Category</li>
                        </ul>
                    </div>            
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                         <div class="header">
                            <h2>Loan Withdrawal Category / <?php echo $blanch_data->blanch_name; ?> - 
                            ...
                            <div class="pull-right">
                                ...
                                <?php if (count($data_loan) > 0) {
                                 ?>
                                 <a href="<?php echo base_url("admin/print_loanWith_category/{$comp_id}/{$blanch_id}/{$category_id}/{$loan_status}") ?>" class="btn btn-primary btn-sm" target="_blank">print</a>
                             <?php }else{ ?>
                          ...
                          <div class="body">
                            <div class="table-responsive">
                                <table class="table table-hover js-basic-example dataTable table-custom">
                                    ...
                                    <tbody>
                                       <?php $no=1 ?>        
                                <?php foreach($data_loan as $loan_aproveds): ?>
                                        <tr>
                                   <!--  <td><?php //echo $no++; ?>.</td> -->
                            ...
                            <?php endforeach; ?>
                              ...
                              <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td><b><?php echo number_format($sum_loan->total_principal); ?></b></td>
                                    <td><b><?php echo number_format($sum_loan->total_loan_interest); ?></b></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
...
<div class="modal fade" id="addcontact3" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open("admin/filter_loan_with_category"); ?>
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-md-12 col-12">
                        <span>Select Branch</span>
