            ...
            <div class="row clearfix">
                ...
                <div class="btn-group" role="group">
                   ...
                   Action
                    ...
                    <a class="dropdown-item" href="<?php echo base_url("admin/view_Dataloan/{$loan_groups->customer_id}/{$loan_groups->comp_id}") ?>"><i class="icon-eye">view</i></a>
                    
                  <a class="dropdown-item" href="<?php echo base_url("admin/reject_loan/{$loan_groups->loan_id}") ?>" onclick="return confirm('Are You Sure?')"><i class="icon-trash">Reject</i></a>

                     <a class="dropdown-item" href="<?php echo base_url("admin/delete_loan/{$loan_groups->loan_id}") ?>" onclick="return confirm('Are you sure?')"><i class="icon-trash">Delete</i></a>
                    </div>
                </div>
                </div>
                                            </td>
