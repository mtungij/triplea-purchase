...
<?php include('incs/side.php'); ?>
                            ...
                            <div class="table-responsive">
                                ...
                                <?php foreach ($group as $groups): ?>
                                        <tr>
                                            ...
                                            <a href="<?php echo base_url("admin/delete_group/{$groups->group_id}"); ?>" class="btn btn-sm btn-icon btn-pure btn-danger on-default button-remove"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
           ...
           <?php echo form_open("admin/modify_group_data/{$groups->group_id}"); ?>
...
<?php include('incs/footer.php'); ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open("admin/create_Groups"); ?>
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-md-6 col-6">
                        <span>Group Name</span>
                    ...
                    <div class="col-md-6 col-6">
                        <span>Branch</span>
                        <select type="number" class="form-control" name="blanch_id" id="blanchs" required>
