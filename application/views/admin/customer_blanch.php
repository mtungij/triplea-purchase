                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">All Customer / <?php echo $blanch_data->blanch_name; ?> </li>
                        </ul>
                    </div>            
                    ...
                    <div class="card">
                         <div class="header">
                            ...
                            <div class="pull-right">
                               ...
                               <a href="<?php echo base_url("admin/view_blanchPanel/{$blanch_id}") ?>" class="btn btn-primary">Back</a> 
                            </div>    
                             </div>
                          <div class="body">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    ...
                    <input type="hidden" name="blanch_id" value="<?php echo $blanch_data->blanch_id; ?>">
            </div>
            </div>
