        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                         <div class="header">
                            <h2>Loan Collection / <?php echo $blanch_data->blanch_name; ?></h2>
                          ...
                          <?php foreach ($data_collection as $loan_collections): ?>
                                   ...
                                   <!--  <td><?php //echo $loan_collections->blanch_name; ?></td>  -->
                                    ...
                                    <td><?php echo number_format($loan_collections->loan_int - $loan_collections->loan_aprove); ?></td>
                                    <td>
                                    ...
                                    <td><?php echo number_format($loan_collections->total_depost + $loan_collections->total_double); ?></td> 
                                    <td>
                                       <?php if (($loan_collections->total_depost + $loan_collections->total_double) > $loan_collections->loan_int) {
                                         ?>
                                         0
                                        <?php }else{?>
                                        <?php echo number_format($loan_collections->loan_int - ($loan_collections->total_depost + $loan_collections->total_double)); ?>
                                            <?php } ?>
                                        </td> 
                                    <td>
                      ...
                      <?php endforeach; ?>
                                   ...
                                   <!--  <td></td> -->
                                    <td></td>
                                    <td><b><?php echo number_format($total_loans->total_aprove); ?></b></td>
                                    <td><b><?php echo number_format($total_loans->total_loan - $total_loans->total_aprove); ?></b></td>
                                    <td><b><?php echo number_format($total_loans->total_loan); ?></b></td>
                                    <td></td>
                                    <td><b><?php //echo number_format($total_receved->total_depost); ?></b></td>
                                    <td>
                                        <b>
                           <?php if (($loan_paid->total_loan_depost + $loan_paid->total_double) >$total_loans->total_loan) {
                         ?>
                        <?php echo $total_loans->total_loan; ?> <b style="color:red;">(<?php echo ($loan_paid->total_loan_depost + $loan_paid->total_double)  - $total_loans->total_loan ?>)</b>
                         <?php }else{ ?>

                        <?php echo number_format($loan_paid->total_loan_depost + $loan_paid->total_double); ?>
                        <?php } ?>
                                    </b>
                                </td>
                                <td><b>
                            <?php if (($loan_paid->total_loan_depost + $loan_paid->total_double) > $total_loans->total_loan) {
                         ?>
                         0 <b style="color:red">(<?php echo ($loan_paid->total_loan_depost + $loan_paid->total_double) - $total_loans->total_loan ?>)</b>
                        <?php }else{ ?>
                        <?php echo number_format($total_loans->total_loan - ($loan_paid->total_loan_depost + $loan_paid->total_double)); ?>
                            <?php } ?></b>
                        </td>
                            <td>
