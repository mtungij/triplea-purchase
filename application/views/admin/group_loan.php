                         ...
                         <div class="header">
                            <h2>Loan  List (<?php echo $group_data->group_name; ?>)</h2>
                             <div class="pull-right">
                                 <a href="<?php echo base_url("admin/group_members"); ?>" class="btn btn-sm btn-primary"><i class="icon-arrow-left"></i></a>
                                 <a href="<?php echo base_url("admin/print_loangroup/{$comp_id}/{$group_id}") ?>" class="btn btn-primary btn-sm" target="_blank"><i class="icon-printer"></i></a>
                             </div>
                             </div>
                          <div class="body">
...
<?php echo form_open("admin/create_withdrow_balance_group/{$customer_loan->customer_id}/{$group_id}",['id'=>'login_with']); ?>
...
<?php echo form_open("admin/deposit_loan_group/{$customer_loan->customer_id}/{$group_id}",['id'=>'login_data']); ?>
<div class="modal-body">
<div class="row clearfix">
