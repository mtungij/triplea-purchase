        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                         <div class="header">
                            <h2>Renew Loan List / <?php echo $blanch_data->blanch_name; ?> From :  <?php echo date('F, j, Y', strtotime($from)) ?> To :  <?php echo date('F, j, Y', strtotime($to)) ?></h2>
                            <div class="pull-right">
                                <a href="" data-toggle="modal" data-target="#addcontact2" class="btn btn-primary"><i class="icon-calendar">Filter</i></a>
                                <a href="<?php echo base_url("admin/renew_loan_aproved"); ?>" class="btn btn-primary"><i class="icon-arrow-left">Back</i></a>
                          ...
                          <div class="body">
                            <div class="table-responsive">
                                <table class="table table-hover js-basic-example dataTable table-custom">
                                    ...
                                    <tbody>
                                       <?php $no = 1 ?>        
                                <?php foreach($prev_renew_loan as $renew_lists): ?>
                                        <tr>
...
<div class="modal fade" id="addcontact2" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open("admin/filter_renew_loan/"); ?>
            <div class="modal-body">
                <div class="row clearfix">
