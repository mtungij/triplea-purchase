...
<?php include('incs/side.php'); ?>
                    ...
                    <div class="card">
                         <div class="header">
                            ...
                            <div class="pull-right">
                                ...
                                <a href="<?php echo base_url("oficer/loan_withdrawal"); ?>" class="btn btn-primary"><i class="icon-arrow-left">Back</i></a>
                          ...
                          <div class="body">
                            <div class="table-responsive">
                                ...
                                <a href="" data-toggle="modal" data-target="#addcontact1<?php echo $renew_lists->renew_id; ?>" class="btn btn-sm btn-primary" title="Edit"><i class="icon-pencil"></i></a>                      
                                  <a href="<?php echo base_url("oficer/delete_renew_loan/{$renew_lists->renew_id}"); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are You Sure?')" title="Remove"><i class="icon-trash"></i></a>
                                 <?php }elseif ($renew_lists->status_renew == 'close') {
                                         ?>
                                    -//-
                                <?php } ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open("oficer/update_renew_loan/{$renew_lists->renew_id}"); ?>
            <div class="modal-body">
                <div class="row clearfix">
                    ...
                    <input type="hidden" name="" value="<?php echo $empl_data->comp_id; ?>">
...
<div class="modal fade" id="addcontact2" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open("oficer/create_renew_loan/{$loan_data->loan_id}"); ?>
            <div class="modal-body">
                <div class="row clearfix">
