                            ...
                            <div class="table-responsive">
                                ...
                                <?php foreach ($group as $groups): ?>
                                        <tr>
                                            ...
                                            <td>
                                            <a href="<?php echo base_url("oficer/view_all_group_loan/{$groups->group_id}"); ?>" title="Members" class="btn btn-sm btn-icon btn-pure btn-primary on-default m-r-5 button-edit" data-target="#addcontact1<?php echo $groups->group_id; ?>" data-original-title="Edit"><i class="icon-users"></i></a>
