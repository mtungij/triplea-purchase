...
<?php include('incs/side.php'); ?>
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <a href="<?php echo base_url("oficer/grops"); ?>" class="btn btn-primary btn-sm"><i class="icon-arrow-left"></i></a>  
                            </div>    
                             </div>
                          <div class="body">
                            <div class="table-responsive">
                                ...
                                <?php foreach ($member as $members): ?>
                                        <tr>
                                            ...
                                            <a href="<?php echo base_url("oficer/remove_member/{$members->id}/{$members->customer_id}"); ?>" class="btn btn-sm btn-icon btn-pure btn-danger on-default button-remove"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open("oficer/update_mebers/{$members->id}/{$members->customer_id}"); ?>
...
<?php include('incs/footer.php'); ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open("oficer/create_mebers/{$group_data->customer_id}"); ?>
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-md-6 col-6">
                        <span>Member Name</span>
