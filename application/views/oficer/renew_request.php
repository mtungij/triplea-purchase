...
<?php $privillage = $this->queries->get_employee_privillage($empl_id);  ?>
    <div id="main-content">
                         ...
                         <div class="header">
                          ...
                          <div class="body">
                            <div class="table-responsive">
                                ...
                                <a href="<?php echo base_url("oficer/delete_renew_loan_data/{$renew_lists->renew_id}"); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are You Sure?')" title="Remove"><i class="icon-trash"></i></a>
                                    <?php }else{ ?>
                                        -//-
                                    <?php } ?>
                                    <?php endforeach; ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open("oficer/aprove_loan_renew/{$renew_lists->renew_id}"); ?>
