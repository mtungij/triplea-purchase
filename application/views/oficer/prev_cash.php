        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                         <div class="header">
                            <h2>Cash Transaction From:<?php echo $from; ?> To: <?php echo $to; ?> </h2> 
                          ...
                          <div class="body">
                            <div class="table-responsive">
                                <table class="table table-hover js-basic-example dataTable table-custom">
                                    ...
                                    <tbody>
                                        <?php $no = 1; ?>
                                <?php foreach ($data_cash as $cashs): ?>
                                              <tr>
                                    <!-- <td><?php //echo $no++; ?>.</td> -->
                                  ...
                                  <!--   <td>
                                    ...
                                    <?php endforeach; ?>
                                     ...
                                     <tr>
                                        ...
                                        <!-- <td></td> -->
                                        <td></td>
                                        <td><b><?php echo number_format($total_cash->total_depost_com); ?></b></</td>
                                        <td><b><?php echo number_format($total_cash->total_comp_aprov); ?></b></td>
                                        <td><b><?php echo number_format($total_cash->total_double); ?></b></td>
                                        <td></td>
                                        <td></td>
                                       <!--  <td></td> -->
                                    </tr>
