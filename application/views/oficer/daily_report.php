                          ...
                          <div class="body">
                            <div class="table-responsive">
                                <table class="table table-hover j-basic-example dataTable table-custom">
                                    ...
                                    <?php endforeach; ?>
                                    <?php $income_today = $this->queries->get_today_income_data($data_account_datas->blanch_id,$data_account_datas->receive_trans_id) ?>
                                    ...
                                    <?php $non_deducted = $this->queries->get_nondeducted_income_account($data_account_datas->blanch_id,$data_account_datas->receive_trans_id);
                                    //echo "<pre>"; 
                                    ...
                                    <tr>
                                     ...
                                     <?php endforeach; ?>
                                     <?php $prepaid = $this->queries->get_today_prepaid($data_account_datas->blanch_id,$data_account_datas->receive_trans_id);
                                       //    echo "<pre>";
                                       // print_r($prepaid);
                                      ?>
                                <?php foreach ($prepaid as $prepaids): ?>
                                     ...
                                     <?php endforeach ?>
                                     <?php $accrual_income = $this->queries->get_out_deposit_today($data_account_datas->blanch_id,$data_account_datas->receive_trans_id);
                                    ...
                                    <?php endforeach; ?>
                                      <?php $daily_deposit = $this->queries->get_daily_deposit($data_account_datas->blanch_id,$data_account_datas->receive_trans_id);
                                      //echo "<pre>";
                                    ...
                                    <?php $weekly_deposit = $this->queries->get_weekly_deposit($data_account_datas->blanch_id,$data_account_datas->receive_trans_id);
                                    ...
                                    <?php endforeach; ?>
                                <?php $monthly_deposit = $this->queries->get_monthly_deposit($data_account_datas->blanch_id,$data_account_datas->receive_trans_id);
                                //print_r($monthly_deposit) ?>
                                 <?php foreach ($monthly_deposit as $monthly_deposits): ?>
                                    ...
                                    <?php endforeach; ?>
                                 <?php $loan_pending = $this->queries->get_system_loan_return($data_account_datas->blanch_id,$data_account_datas->receive_trans_id);
                                  ...
                                  ?>
                                   <?php foreach ($loan_pending as $loan_pendings): ?>
                                    ...
                                    <?php endforeach; ?>
                                    <?php $double_loan = $this->queries->get_double_amount($data_account_datas->blanch_id,$data_account_datas->receive_trans_id);?>
                                    ...
                                    <tr>
                                     ...
                                     <?php endforeach; ?>
                                    <?php $from_main_account = $this->queries->get_transaction_from_mainAccount($data_account_datas->blanch_id,$data_account_datas->receive_trans_id); ?>
                                    ...
                                    <tr>
                                     ...
                                     <?php endforeach; ?>
                                     <?php $from_blanch_blanch = $this->queries->get_transaction_from_blanch($data_account_datas->blanch_id,$data_account_datas->receive_trans_id);
                                     // echo "<pre>";
                                    ...
                                    //print_r($saving_deposit);
                                     ...
                                     <?php $loan_with = $this->queries->get_loan_withdrawal_account($data_account_datas->blanch_id,$data_account_datas->receive_trans_id);
                                     // echo "<pre>";
                                     // print_r($loan_with) ?>
                                     ...
                                     <?php $renew_loan = $this->queries->get_loan_renew_blanch($data_account_datas->blanch_id,$data_account_datas->receive_trans_id);
                                     // echo "<pre>";
                                     // print_r($renew_loan);
                                      ?>
                                     ...
                                     <?php endforeach; ?>
                                     <?php $expenses = $this->queries->get_expenses_datas($data_account_datas->blanch_id,$data_account_datas->receive_trans_id);
                                     // print_r($expenses) 
                                     ?>
                                     ...
                                     <?php endforeach; ?>
                                     <?php $transactions_float = $this->queries->get_transaction_day_toBlanch($data_account_datas->blanch_id,$data_account_datas->receive_trans_id);
                                     // echo "<pre>";
