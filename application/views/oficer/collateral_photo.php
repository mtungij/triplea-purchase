      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="crop">Crop</button>
                            ...
                            <input type="hidden" name="loan_id"  id="loan_id" value="<?php //echo $loan_attach->loan_id; ?>">
                                ...
                                <a href="<?php echo base_url("oficer/collelateral_session/{$loan_id}"); ?>" class="btn btn-primary"><i class="icon-arrow-left"></i></a>
                                </div>
                            <?php echo form_close();  ?>
                        </div>
                    </div>
    ...
    bs_modal.on('shown.bs.modal',function(){
        ...
        reader.onload = function(){
            ...
            $.ajax({
                type:"POST",
                //dataType:"json",
             url:"<?php echo base_url(); ?>oficer/update_collateral_data",
